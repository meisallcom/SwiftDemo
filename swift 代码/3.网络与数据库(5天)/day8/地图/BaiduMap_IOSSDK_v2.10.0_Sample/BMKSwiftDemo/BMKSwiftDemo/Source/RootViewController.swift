...
class RootViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    let _demoNameArray = ["基本地图功能-MapViewBaseDemo",
    ...
    let _viewControllerTitleArray = ["基本地图功能",
        "多地图使用功能",
        "图层展示功能",
        "地图操作功能",
        "UI控制功能",
...
//        customMapStyle()//自定义地图样式
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier(_viewControllerArray[indexPath.row])
