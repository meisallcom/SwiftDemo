...
class CloudSearchDemoViewController: UIViewController, BMKMapViewDelegate, BMKCloudSearchDelegate  {
    ...
    //发起本地云检索
    @IBAction func onClickLocalSearch(sender: UIButton) {
    ...
    // 发起周边云检索
    @IBAction func onClickNearbySearch(sender: UIButton) {
    ...
    // 发起矩形云检索
    @IBAction func onClickBoundSearch(sender: UIButton) {
    ...
    // 发起详情云检索
    @IBAction func onClickDetailSearch(sender: UIButton) {
